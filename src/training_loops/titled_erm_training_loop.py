...
train_only_group_dro_with_data_augmentation_via_mixup_super_group, train_only_group_dro_with_data_augmentation_via_mixup_super_group_and_example_similarity
...
from .various_fairness_regularization import erm_super_group_with_simplified_fairness_loss, train_only_group_dro_super_group_with_simplified_fairness_loss
...
def training_loop(training_loop_parameters: TrainingLoopParameters):
    ...
    elif training_loop_type in ['train_with_mixup_only_one_group_based_distance_v3', 'train_only_group_dro_with_mixup_regularizer_super_group',
                       'train_only_group_dro_with_super_group'] or 'super_group' in training_loop_type:
    ...
    for ep in range(training_loop_parameters.n_epochs):
        ...
        if training_loop_type == 'tilted_erm_with_mixup':
        ...
        elif training_loop_type == 'only_titled_erm_with_mask':
            train_epoch_metric, loss, global_weight, global_loss = train_only_tilted_erm_with_mask(train_parameters)

        elif training_loop_type == 'only_tilted_erm_with_weights_on_loss':
            train_epoch_metric, loss, global_weight, global_loss = train_only_tilted_erm_with_weights_on_loss(train_parameters)
            ...
            train_epoch_metric, loss, global_weight, global_loss = train_with_mixup_only_one_group_based_distance_v3(
                train_parameters)
        ...
        elif training_loop_type in ['train_only_group_dro_with_data_augmentation_via_mixup_super_group_and_example_similarity_v1',
        ...
        elif training_loop_type in ['train_only_group_dro_super_group_with_simplified_fairness_loss']:
            train_epoch_metric, loss, global_weight, global_loss = train_only_group_dro_super_group_with_simplified_fairness_loss(train_parameters)
        else:
            raise NotImplementedError
