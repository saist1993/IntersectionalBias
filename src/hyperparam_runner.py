...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_name', '-name', help="log file name", type=str, default=None)
    parser.add_argument('--use_wandb', '-use_wandb', help="log file name", type=bool, default=False)
            ...
            for fairness_scale in fairness_scales:
                try:
                    runner_arguments = RunnerArguments(
                        ...
                        optimizer_name=args.optimzer_name,
                        lr=args.lr,
